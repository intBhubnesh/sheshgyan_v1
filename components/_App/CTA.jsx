  ...
  return (
    <>
                ...
                <div className='flex flex-col items-start justify-center w-full gap-3 px-8 md:gap-6 md:mr-6 md:max-w-1/2 '>
                    <h1 className='text-4xl text-white uppercase heading md:text-8xl'>Ready to Empower Young Minds?</h1>
                    <p className='text-sm text-justify capitalize para md:text-lg text-white/90 '>Join us in shaping the future of education! Whether you're a school, parent, or educator, let's work together to bring cutting-edge learning to the next generation.</p>
                    <button className='px-6 py-3 rounded-full text-[#505050] bg-white inline-flex items-center justify-center'>
                        <h2 className='uppercase sub-heading'>Know More</h2>
                    </button>
                </div>
            </div>
