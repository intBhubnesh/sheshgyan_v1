...
const UploadVideoForm = ({ courseId }) => {
    ...
    <div className="form-group">
        ...
        <input
            ...
            className="form-control file-control"
            name="video"
            accept="video/*, image/*" // Allows both videos and images
            onChange={handleChange}
        />
        <small className="form-text">
            You can upload a video or an image. If an image is uploaded, it will be treated as a video.
        </small>
    </div>
				...
				<div className="col-md-6">
					<div className="form-group">
						<label className="form-label fw-semibold">Video Date</label>
						<input
							type="date"
							className="form-control"
							name="video_date"
