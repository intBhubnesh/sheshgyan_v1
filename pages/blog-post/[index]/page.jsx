...
const BlogDetail = () => {
    ...
    const post = blog_posts[index]; // Fetch the blog post using the index
    const [activeSection, setActiveSection] = useState("");

    const displayedPosts = blog_posts.slice(0, 4);


    if (!post) return <p>Loading...</p>; // Handle cases where post is undefined
                ...
                <div className="flex flex-col items-center justify-center w-full gap-4 ">
                    <div>
                        ...
                        <div className='inline-flex items-center justify-center gap-4'>
                            ...
                            <h1 className='md:text-6xl text-4xl text-center uppercase text-[#FF6200]'>{post.heading}</h1>
          ...
          <div id={section.heading} key={section.heading} className="scroll-mt-20">
            ...
            <div className=' md:px-12'>
                    <Sectionheading tag='Suggestion' heading='Blog-posts' desc='Explore expert articles, industry trends, and success stories in education and technology, helping students, parents, and schools stay ahead in the digital era.' />
                        ...
                        <div className="grid w-full grid-cols-2 gap-2 p-2 mt-6 md:gap-6 md:px-12 md:grid-cols-4">
                                ...
                                group-hover:shadow-[16px_16px_0px_0px_#FF6200]"
                                    ...
                                    <div className="flex flex-col gap-2 p-2">
                                        <div className="flex flex-col items-start justify-between gap-2">
                                            <div className="text-xs text-[#171717]/90 flex items-center md:gap-3 gap-2 text-nowrap">
                                                <h6>{posts.date}</h6>
                                                <div className="rounded-full size-1 bg-[#616161]/50"></div>
