...
import subjects from "../src/data/subjects"; // Updated from "./data/subjects"
import team_members from "../src/data/team"; // Updated from './data/team'
      ...
      <div className="w-full pt-40 overflow-hidden lg:pt-56">
        ...
        <div className="relative flex flex-col-reverse items-center justify-between w-full h-auto mb-32 lg:h-96 lg:flex-row lg:items-start lg:px-8 xl:px-20">
          ...
          <div className="flex flex-col max-w-[560px] w-full p-2">
            <h1 className="heading text-[44px] sm:text-6xl font-semibold leading-16 sm:leading-[84px] sm:tracking-[1.44px] text-[#2F303B] uppercase mb-3.5 text-center">
              Shaping Young <span className="text-[#FF6200]">Minds</span> for{" "}
              <br />a <span className="text-[#FF6200]">Tech-Driven</span> Future
            </h1>
            <p className="para text-[#1F1F1F]/60 lg:max-w-[460px] xl:max-w-[560px] text-justify font-manrope text-base font-medium tracking-[0.216px] mb-9">
              Technology is more than just learning—it's about building,
              innovating, and leading. We equip students with the skills and
              confidence to navigate the digital world, turning curiosity into
              real-world impact.
            </p>
        ...
        <div className=" xl:p-24 sm:py-18 bg-[#FFDDA3] p-2 m-2 sm:m-5 flex flex-col gap-10 sm:gap-12 rounded-[52px]">
          <Sectionheading
            tag="Benefits"
            heading="Our Impact"
            desc="We’re transforming education by equipping students with future-ready skills, empowering educators with the right tools, and helping schools stay ahead in the digital era."
          />
          <div className="flex flex-col items-center justify-center gap-4 md:gap-10 md:flex-row xl:gap-32">
            <img
              className="w-44 sm:w-60 md:w-72 lg:w-[400px]  "
            ...
            <div className="inline-flex gap-4 md:gap-6 lg:gap-8 flex-col items-center justify-center sm:max-w-[540px]">
              ...
              <div className="inline-flex flex-col items-center justify-center gap-2 sm:items-center lg:items-start sm:gap-8 ">
                <h1 className="heading text-4xl sm:text-7xl   text-[#FF6200] ">
                  Future-Ready Learning
                </h1>
                <p className="para text-sm sm:text-lg capitalize  text-justify text-[#1F1F1F] p-2 sm:p-0">
                  Empower students with AI, IoT, Robotics, and Programming
                  through hands-on, industry-aligned courses. Our practical
                  approach ensures they grasp real-world applications of modern
                  technology.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col-reverse items-center justify-center gap-4 md:gap-10 md:flex-row xl:gap-32">
            <div className="inline-flex gap-4 sm:gap-8 flex-col items-center justify-center sm:max-w-[540px]">
              ...
              <div className="inline-flex gap-4 md:gap-6 lg:gap-8 flex-col items-center justify-center sm:max-w-[540px]">
                ...
                <p className="para text-sm sm:text-lg capitalize  text-justify text-[#1F1F1F] p-2 sm:p-0">
                  Certified trainers deliver interactive sessions, workshops,
                  and teacher training programs. We help educators stay ahead
                  with cutting-edge knowledge, ensuring a seamless tech-learning
                  experience.
                </p>
              </div>
            </div>
            <img
              className="w-56 sm:w-64 md:w-80 lg:w-[540px]"
          ...
          <div className="flex flex-col items-center justify-center gap-4 pb-16 md:gap-10 md:flex-row xl:gap-32">
            <img
              className="w-40 sm:w-60 md:w-72 lg:w-[380px]"
            ...
            <div className="inline-flex gap-4 md:gap-6 lg:gap-8 flex-col items-center justify-center sm:max-w-[540px]">
              ...
              <div className="inline-flex flex-col items-center justify-center gap-2 sm:items-center lg:items-start sm:gap-8">
                <h1 className="heading text-4xl sm:text-7xl  text-[#FF6200] ">
                  Shaping Smarter Minds
                </h1>
                <p className="para text-sm sm:text-lg capitalize  text-justify text-[#1F1F1F] p-2 sm:p-0">
                  Foster innovation and critical thinking with future-focused
                  education. Our programs prepare students to excel in a
                  tech-driven world, equipping them with the skills to thrive.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col w-full gap-4 p-2 sm:gap-10 sm:p-24">
          <div className="inline-flex flex-col w-full gap-6 px-6 py-4 sm:p-0">
            <div className="flex items-center justify-end">
              <h5 className="para  text-xs uppercase bg-[#FFDDA3] py-1.5 px-4 text-[#FF6200] inline-flex rounded-lg">
                Subject
              </h5>
            </div>
            <div className="flex flex-col items-end justify-between w-full gap-2 md:flex-row sm:items-start">
              <h1 className="heading uppercase text-4xl sm:text-7xl text-[#FF6200]">
                Fields of Study
              </h1>
              <p className="para md:text-base text-justify text-xs text-[#1F1F1F]/80 max-w-[540px]">
                Discover exciting subjects like AI, Robotics, IoT, and
                Programming, designed to equip students with real-world tech
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 p-6 md:mt-12 bg-[#FFDDA3] py-12 rounded-4xl">
            {subjects.map((subject, index) => (
              ...
              >
                ...
                <h1 className="inline-flex items-center justify-center text-2xl uppercase heading sm:text-4xl">
                  {subject.name}
                </h1>
              </div>
            ))}
        ...
        <div className="flex flex-col w-full gap-2 p-2 mt-4 sm:p-24 bg-[#F3F2F7] rounded-4xl">
          <Sectionheading
            ...
            desc="SheshGyan is on a mission to transform education by integrating hands-on tech learning into schools. Based in Bengaluru, we partner with educators to bring expert-led training in AI, Robotics, IoT, and more—ensuring students gain real-world skills for the future."
          />
          ...
          <div className="flex flex-col items-center justify-between sm:flex-row ">
            ...
            <div className="flex flex-col w-2/3 gap-8">
              <div
                ...
                className=" inline-flex items-center justify-center p-10 w-full sm:w-[80%]  bg-white relative rounded-4xl shadow-[8px_8px_0px_0px_#FF6200,0px_2px_23px_0px_#FFE0CD] ml-12"
              >
              ...
              <div
                style={{ borderRadius: "2rem" }}
                className="inline-flex items-center w-full sm:w-[80%] justify-center p-8 sm:p-8 pl-12 sm:pl-16 bg-white relative rounded-4xl  shadow-[8px_8px_0px_0px_#FF6200,0px_2px_23px_0px_#FFE0CD] sm:mr-12"
              >
                ...
                <h1 className="heading text-[#7F7F7F] text-xl  sm:text-3xl  max-w-[500px]">
                  <span className="text-[#FF6200]">Bridging</span> the gap
                  between <span className="text-[#FF6200]">education</span> and{" "}
                  <span className="text-[#FF6200]">industry</span> by hands-on{" "}
                  <span className="text-[#FF6200]">technology learning</span>{" "}
                  into <span className="text-[#FF6200]">classrooms</span>.
                </h1>
        ...
        <div className="flex flex-col w-full gap-4 my-24 sm:gap-10 xl:p-8">
          <Sectionheading
            ...
            desc="Discover exciting subjects like AI, Robotics, IoT, and Programming, designed to equip students with real-world tech skills for the future."
            isRight={false}
          />
              ...
              {journy.map((phase, index) => (
                ...
                >
                  ...
                  <div className="inline-flex gap-1 flex-col max-w-[520px]">
                    <h1 className="sub-heading text-lg sm:text-2xl lg:text-4xl text-[#505050] uppercase">
                      {phase.heading}
                    </h1>
                    <p className="para text-xs sm:text-sm text-[#2E2E2E]/80 text-justify">
                      {phase.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="m-2 sm:m-10 bg-[#FFDDA3] flex flex-col gap-2 sm:gap-12 rounded-4xl sm:px-12 sm:py-16">
          <Sectionheading
            tag="Team"
            heading="Our Impact"
            desc="Driven by the mission to bridge the gap between traditional education and future skills, we are committed to empowering students and schools alike."
          />
            ...
            <div
              ...
              className={`${
                index % 2 !== 0
                  ...
                  : "flex-col-reverse "
              } flex-col sm:flex-row flex items-center justify-center w-full gap-[40px] mb-6 sm:mb-0`}
            >
