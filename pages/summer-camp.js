...
import cources from "../src/data/cources"; // Updated from './data/cources'
import Testimonial from "../components/_App/Testimonial";
import testimonials from "../src/data/testimonials"; // Updated from './data/testimonials'
  ...
  return (
    <div className="w-full mt-40">
      ...
      <div className="flex flex-col items-center justify-center w-full gap-6 md:p-5 ">
        <div
          className="inline-flex md:flex-row flex-col md:p-8 p-4  item-center   justify-between border-2 border-[#1F1F1F]/60 rounded-3xl w-[90%]   md:gap-6 gap-4"
        ...
        >
          ...
          <div className="inline-flex flex-col w-full gap-2 md:gap-4 md:w-1/3">
            <h1 className="heading  text-[#FF6200]  md:text-5xl text-3xl">
              SUMMER CAMP 2025
            </h1>
            <div className="flex justify-between item-center">
              <div className="gap-1.5 flex flex-row items-center justify-center">
                ...
                <h3 className="text-sm tracking-tight md:text-xs ">
                  12 March 2025
                </h3>
              </div>
            ...
            <p className="para md:text-base text-xs text-[#1F1F1F] text-justify">
            ...
            <div>
              <h2 className="sub-heading  text-[#6D6D6D] md:text-2xl text-lg uppercase">
                Why Participate{" "}
              </h2>
      ...
      <div
        id="View_Courses"
        className="flex flex-col items-center justify-center w-full p-2 my-12 md:gap-6 md:p-12"
      >
        <Sectionheading
          tag="Programs"
          heading="Future Learning"
          desc="At SheshGyan, we offer a range of hands-on learning programs designed for students from Class 3 to 9. Our courses focus on coding, AI, robotics, and STEM, ensuring young learners develop essential problem-solving, creativity, and critical thinking skills."
        />
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="flex items-center justify-between w-[80%] gap-1 my-5 md:px-5 md:my-10 md:gap-2">
              {cources.map((_, index) => (
                ...
                >
                  <h1
                    className={`text-xl heading md:text-4xl ${
                      activeIndex === index
      ...
      <div className="bg-[#FF7C2B] w-full pb-12">
        <Sectionheading
          tag="achivements"
          heading="Tech Leaders"
          desc="Empowering young minds with cutting-edge skills in electronics, IoT, and smart technologies, preparing them to innovate and lead in the digital era."
          isRight={false}
          bg="orange"
          className="p-12"
        />
          ...
          {achivements.map((achivement, index) => (
            ...
            >
              ...
              <div className="inline-flex flex-col items-center justify-center gap-2 mb-6">
                <h1 className="heading text-4xl text-[#505050] uppercase">
                  {achivement.heading}
                </h1>
                <p className="para text-sm font-semibold text-[#1F1F1F]/60">
                  {achivement.desc}
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col items-center justify-center w-full gap-20 my-12 md:p-12">
        <Sectionheading
          ...
          desc="Explore hands-on learning at our offline centers across India. Designed for interactive and practical education, our hubs bring technology and innovation closer to students."
        />
        <div className="relative ">
          ...
          <div className="absolute top-4 right-6  md:p-4 p-2 md:gap-4 gap-1 inline-flex flex-col md:mx-10 mx-2   border-[1.5px] border-[#1F1F1F]/60  md:rounded-2xl rounded-xl">
            <h2 className="sub-heading md:text-3xl text-base tracking-wider uppercase text-[#6D6D6D]">
              offline center
            </h2>
            <div className="flex flex-col items-start gap-1 md:gap-2">
              <div className="inline-flex items-start justify-start gap-3">
                ...
                <h4 className="font-semibold md:text-lg text-xs text-[#1F1F1F]/80">
                  Available
                </h4>
              </div>
