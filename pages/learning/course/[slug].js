...
const Index = ({ user }) => {
    ...
    const [selectedVideo, setSelectedVideo] = useState(""); // Could be video or image
    ...
    const selectVideo = async (videoId) => {
        try {
            ...
            console.error("Error selecting video:", err); // Improved error logging
            console.log(err.response?.data); // Conditional chaining
        }
    };

    // NEW FUNCTION:  Handles the asset selection from ProgressManager
    const handleAssetSelect = (assetUrl) => {
        setSelectedVideo(assetUrl); // Update state with the image URL
    };
                    ...
                    <div className="row">
                        <div className="col-lg-9 col-md-8">
                            <div className="video-content">
                                {selectedVideo && (
                                    <Player src={selectedVideo} /> // Passing selectedVideo as src
                                )}
                            ...
                            <StickyBox offsetTop={20} offsetBottom={20}>
                                <div className="video-sidebar">
                                    <ProgressManager
                                        ...
                                        onAssetSelect={handleAssetSelect} // PASSING THE FUNCTION
                                    />
